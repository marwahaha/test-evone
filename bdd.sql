...
INSERT INTO `bitbag_cms_block` VALUES (1,'bloc1',1);
...
CREATE TABLE `bitbag_cms_block_channels` (
  ...
  CONSTRAINT `FK_8417B073E9ED820C` FOREIGN KEY (`block_id`) REFERENCES `bitbag_cms_block` (`id`)
...
INSERT INTO `bitbag_cms_block_channels` VALUES (1,1),(1,3);
...
INSERT INTO `bitbag_cms_block_sections` VALUES (1,1);
...
INSERT INTO `bitbag_cms_block_translation` VALUES (1,1,'Bloc1','<div id=\"block1-container\" style=\"background:#cc5581; border:1px solid #cccccc; padding:5px 10px\">\r\n<p style=\"text-align:center\"><span style=\"font-size:72px\">Block 1</span></p>\r\n</div>',NULL,'en_US'),(2,1,'Bloc 1','<div id=\"block1-container\" style=\"background:#eeeeee; border:1px solid #cccccc; padding:5px 10px\">\r\n<p style=\"text-align:center\"><span style=\"font-size:72px\">Bloc&nbsp;1</span></p>\r\n</div>\r\n\r\n<p>&nbsp;<img alt=\"\" src=\"/media/image/f7/44/e27f06041dd4251ccb87be0931e8.png\" /></p>',NULL,'fr');
...
INSERT INTO `bitbag_cms_faq` VALUES (1,'acceptable-solution',1,1);
...
INSERT INTO `bitbag_cms_faq_channels` VALUES (1,1),(1,3);
...
INSERT INTO `bitbag_cms_faq_translation` VALUES (1,1,'Does Sylius is an acceptable solution ?','Yes it is.','en_US'),(2,1,'Est-ce que Sylius est une solution acceptable ?','Oui c\'est le cas.','fr');
...
INSERT INTO `bitbag_cms_media` VALUES (1,'Screenshot_from_2018_10_03_11_57_31','image','/media/image/f7/44/e27f06041dd4251ccb87be0931e8.png','image/png',1);
...
CREATE TABLE `bitbag_cms_media_channels` (
  ...
  CONSTRAINT `FK_D109622EE9ED820C` FOREIGN KEY (`block_id`) REFERENCES `bitbag_cms_media` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bitbag_cms_page` VALUES (1,'home',1,'2018-10-11 10:21:47','2018-10-11 12:33:45'),(2,'best-products',1,'2018-10-11 10:38:58','2018-10-11 10:38:59'),(3,'test',1,'2018-10-11 10:40:25','2018-10-11 10:40:25');
...
CREATE TABLE `bitbag_cms_page_channels` (
  ...
  CONSTRAINT `FK_DCA4269C4663E4` FOREIGN KEY (`page_id`) REFERENCES `bitbag_cms_page` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bitbag_cms_page_channels` VALUES (1,1),(1,3),(2,1),(2,3),(3,1),(3,3);
...
INSERT INTO `bitbag_cms_page_products` VALUES (2,1),(2,3);
...
INSERT INTO `bitbag_cms_page_sections` VALUES (1,1),(3,1);
...
INSERT INTO `bitbag_cms_page_translation` VALUES (1,1,'accueil','Accueil',NULL,'accueil','Page d\'accueil',NULL,NULL,'<h3>&nbsp;</h3>\r\n\r\n<h3><img alt=\"\" src=\" \" style=\"float:left; height:100px; margin-right:10px; width:100px\" />Type the title here</h3>\r\n\r\n<p>Type the text here</p>','fr'),(2,2,'best-products','Best products','best-products','best-products',NULL,NULL,NULL,'<div>\r\n<p>&nbsp;</p>\r\n</div>','en_US'),(3,2,'nos-plus-beaux-produits','Nos plus beaux produits','nos-plus-beaux-produits',NULL,NULL,NULL,NULL,'<div>\r\n<p>&nbsp;</p>\r\n</div>','fr'),(4,3,'test','Test','test',NULL,NULL,NULL,NULL,'<div>\r\n<p>&nbsp;</p>\r\n</div>','en_US'),(5,3,'test','Test','test',NULL,NULL,NULL,NULL,'<div>\r\n<p>&nbsp;</p>\r\n</div>','fr');
...
INSERT INTO `bitbag_cms_section` VALUES (1,'row1');
...
INSERT INTO `bitbag_cms_section_translation` VALUES (1,1,'Row1','en_US'),(2,1,'Ligne1','fr');
...
INSERT INTO `migration_versions` VALUES ('20170912085504'),('20170913125128'),('20171003103916'),('20180102140039'),('20181010163351'),('20181011071709');
...
INSERT INTO `sylius_address` VALUES (1,NULL,'cédric','torres',NULL,'2 rue de la fosse aux lions','dg','nantes','44300','2018-10-03 12:38:36','2018-10-03 12:38:36','FR',NULL,'ça va imhotep'),(2,NULL,'cédric','torres',NULL,'2 rue de la fosse aux lions','dg','nantes','44300','2018-10-03 12:38:36','2018-10-03 12:38:36','FR',NULL,'ça va imhotep');
...
INSERT INTO `sylius_address_log_entries` VALUES (1,'create','2018-10-03 12:38:36','1','Sylius\\Component\\Core\\Model\\Address',1,'a:10:{s:9:\"firstName\";s:7:\"cédric\";s:8:\"lastName\";s:6:\"torres\";s:11:\"phoneNumber\";N;s:6:\"street\";s:27:\"2 rue de la fosse aux lions\";s:7:\"company\";s:2:\"dg\";s:4:\"city\";s:6:\"nantes\";s:8:\"postcode\";s:5:\"44300\";s:11:\"countryCode\";s:2:\"FR\";s:12:\"provinceCode\";N;s:12:\"provinceName\";s:14:\"ça va imhotep\";}',NULL),(2,'create','2018-10-03 12:38:36','2','Sylius\\Component\\Core\\Model\\Address',1,'a:10:{s:9:\"firstName\";s:7:\"cédric\";s:8:\"lastName\";s:6:\"torres\";s:11:\"phoneNumber\";N;s:6:\"street\";s:27:\"2 rue de la fosse aux lions\";s:7:\"company\";s:2:\"dg\";s:4:\"city\";s:6:\"nantes\";s:8:\"postcode\";s:5:\"44300\";s:11:\"countryCode\";s:2:\"FR\";s:12:\"provinceCode\";N;s:12:\"provinceName\";s:14:\"ça va imhotep\";}',NULL);
...
INSERT INTO `sylius_adjustment` VALUES (59,1,NULL,NULL,'shipping','UPSRoxx',15000,0,0,NULL,'2018-10-03 13:03:26','2018-10-03 13:03:26'),(60,NULL,NULL,10,'order_promotion','Greatest Promotion',-58,0,0,'COOL2K18','2018-10-03 13:03:26','2018-10-03 13:03:26'),(61,NULL,NULL,10,'tax','Fisting surprise (80%)',753,0,0,NULL,'2018-10-03 13:03:26','2018-10-03 13:03:26'),(62,NULL,NULL,2,'order_promotion','Greatest Promotion',-59,0,0,'COOL2K18','2018-10-03 13:03:26','2018-10-03 13:03:26'),(63,NULL,NULL,2,'tax','Fisting surprise (80%)',753,0,0,NULL,'2018-10-03 13:03:26','2018-10-03 13:03:26'),(64,NULL,NULL,3,'order_promotion','Greatest Promotion',-59,0,0,'COOL2K18','2018-10-03 13:03:26','2018-10-03 13:03:26'),(65,NULL,NULL,3,'tax','Fisting surprise (80%)',753,0,0,NULL,'2018-10-03 13:03:26','2018-10-03 13:03:26'),(66,NULL,NULL,4,'order_promotion','Greatest Promotion',-59,0,0,'COOL2K18','2018-10-03 13:03:26','2018-10-03 13:03:26'),(67,NULL,NULL,4,'tax','Fisting surprise (80%)',753,0,0,NULL,'2018-10-03 13:03:26','2018-10-03 13:03:26'),(68,NULL,NULL,5,'order_promotion','Greatest Promotion',-59,0,0,'COOL2K18','2018-10-03 13:03:26','2018-10-03 13:03:26'),(69,NULL,NULL,5,'tax','Fisting surprise (80%)',753,0,0,NULL,'2018-10-03 13:03:26','2018-10-03 13:03:26'),(70,NULL,NULL,6,'order_promotion','Greatest Promotion',-59,0,0,'COOL2K18','2018-10-03 13:03:26','2018-10-03 13:03:26'),(71,NULL,NULL,6,'tax','Fisting surprise (80%)',753,0,0,NULL,'2018-10-03 13:03:26','2018-10-03 13:03:26'),(72,NULL,NULL,7,'order_promotion','Greatest Promotion',-59,0,0,'COOL2K18','2018-10-03 13:03:26','2018-10-03 13:03:26'),(73,NULL,NULL,8,'order_promotion','Greatest Promotion',-59,0,0,'COOL2K18','2018-10-03 13:03:26','2018-10-03 13:03:26'),(74,NULL,NULL,9,'order_promotion','Greatest Promotion',-29,0,0,'COOL2K18','2018-10-03 13:03:26','2018-10-03 13:03:26');
...
INSERT INTO `sylius_admin_user` VALUES (1,'ctorres','ctorres',1,'6zlvowryzbks8gkwsg4ockocw008ksc','FwvKmGr0AAuTQ8Mk3AvHcXN4w0y4QZxLrt//e5byzZd8Tr9bhvAkT5OeMMUu72xjMwwdLteJu8cukVbC+4lcsg==','2018-10-11 14:48:57',NULL,NULL,NULL,NULL,0,NULL,NULL,'a:1:{i:0;s:26:\"ROLE_ADMINISTRATION_ACCESS\";}','ctorres@digitalgarden.fr','ctorres@digitalgarden.fr','2018-10-03 11:57:02','2018-10-11 14:48:57',NULL,NULL,'fr');
...
INSERT INTO `sylius_channel` VALUES (1,2,1,1,'default','Default','#ff0005',NULL,1,'fr.sylius-shop.com','2018-10-03 11:57:02','2018-10-10 14:34:44',NULL,'order_items_based',NULL,0,0,1),(3,1,2,NULL,'us','Shop US','#8080ff',NULL,1,'us.sylius-shop.com','2018-10-10 17:19:22','2018-10-10 17:19:22',NULL,'order_items_based','ctorres@digitalgarden.fr',0,0,1);
...
INSERT INTO `sylius_channel_currencies` VALUES (1,1),(3,2);
...
INSERT INTO `sylius_channel_locales` VALUES (1,2),(3,1);
...
INSERT INTO `sylius_channel_pricing` VALUES (1,1,1000,1500,'default'),(2,2,1200,1500,'default'),(3,3,1000,1000,'default'),(4,4,1000,1000,'default'),(5,5,1200,1200,'default'),(6,6,500,500,'default'),(7,7,600,600,'default'),(8,8,500,500,'default'),(9,9,500,500,'default'),(10,1,1000,1000,'local_dev_us'),(11,2,1200,NULL,'local_dev_us'),(12,6,1000,1000,'local_dev_us'),(13,7,600,600,'local_dev_us'),(14,8,500,500,'local_dev_us'),(15,9,500,500,'local_dev_us'),(16,2,1000,1000,'us'),(17,1,1000,1000,'us'),(18,6,500,500,'us'),(19,7,600,600,'us'),(20,8,600,600,'us'),(21,9,600,600,'us');
...
INSERT INTO `sylius_country` VALUES (1,'FR',1),(2,'US',1);
...
INSERT INTO `sylius_currency` VALUES (1,'EUR','2018-10-03 11:57:02','2018-10-03 11:57:02'),(2,'USD','2018-10-10 11:08:51','2018-10-10 11:08:51');
...
INSERT INTO `sylius_customer` VALUES (1,NULL,NULL,'ctorres@digitalgarden.fr','ctorres@digitalgarden.fr',NULL,NULL,NULL,'u','2018-10-03 12:38:36','2018-10-03 12:38:36',NULL,0);
...
INSERT INTO `sylius_gateway_config` VALUES (1,'stripe','stripe_checkout','{\"publishable_key\":\"edrfghjkl\",\"secret_key\":\"fghjklmghjk\"}');
...
INSERT INTO `sylius_locale` VALUES (1,'en_US','2018-10-03 11:57:02','2018-10-03 11:57:02'),(2,'fr','2018-10-03 12:19:19','2018-10-03 12:19:19');
...
INSERT INTO `sylius_order` VALUES (1,1,2,1,NULL,1,NULL,NULL,'cart',NULL,12518,15000,27518,'2018-10-03 12:22:47','2018-10-03 13:03:26','EUR','fr','payment_selected','cart','cart',NULL,NULL),(3,NULL,NULL,3,NULL,NULL,NULL,NULL,'cart',NULL,0,0,0,'2018-10-10 17:23:17','2018-10-10 17:25:42','USD','en_US','cart','cart','cart',NULL,NULL);
...
INSERT INTO `sylius_order_item` VALUES (1,1,1,6,1000,10165,0,10165,0,NULL,NULL),(2,1,3,2,1000,1882,0,1882,0,NULL,NULL),(3,1,9,1,500,471,0,471,0,NULL,NULL);
...
INSERT INTO `sylius_order_item_unit` VALUES (2,1,1,694,'2018-10-03 12:23:00','2018-10-03 13:03:26'),(3,1,1,694,'2018-10-03 12:23:00','2018-10-03 13:03:26'),(4,1,1,694,'2018-10-03 12:23:00','2018-10-03 13:03:26'),(5,1,1,694,'2018-10-03 12:24:23','2018-10-03 13:03:26'),(6,1,1,694,'2018-10-03 12:24:27','2018-10-03 13:03:26'),(7,2,1,-59,'2018-10-03 12:31:13','2018-10-03 13:03:26'),(8,2,1,-59,'2018-10-03 12:31:13','2018-10-03 13:03:26'),(9,3,1,-29,'2018-10-03 13:03:01','2018-10-03 13:03:26'),(10,1,1,695,'2018-10-03 13:03:26','2018-10-03 13:03:26');
...
INSERT INTO `sylius_payment` VALUES (1,1,1,'EUR',27518,'cart','[]','2018-10-03 12:38:36','2018-10-03 13:03:26');
...
INSERT INTO `sylius_payment_method` VALUES (1,1,'stripe',NULL,1,1,'2018-10-03 12:33:22','2018-10-03 12:33:22');
...
INSERT INTO `sylius_payment_method_translation` VALUES (1,1,'Visa / Mastercard',NULL,NULL,'en_US'),(2,1,'Visa / Mastercard',NULL,NULL,'fr');
...
INSERT INTO `sylius_product` VALUES (1,1,'PDT-001','2018-10-03 12:08:55','2018-10-10 17:22:38',1,'match',0),(2,NULL,'PDT-002','2018-10-03 12:29:59','2018-10-03 12:30:00',1,'choice',0),(3,NULL,'PDT-003','2018-10-03 12:53:38','2018-10-03 12:57:06',1,'choice',0),(4,NULL,'PDT-004','2018-10-03 13:00:48','2018-10-10 17:22:48',1,'match',0);
...
INSERT INTO `sylius_product_attribute` VALUES (1,'color','text','text','a:2:{s:3:\"min\";d:1;s:3:\"max\";d:30;}','2018-10-03 12:09:36','2018-10-03 12:09:36',1);
...
INSERT INTO `sylius_product_attribute_translation` VALUES (1,1,'Color','en_US');
...
INSERT INTO `sylius_product_channels` VALUES (1,1),(1,3),(2,1),(3,1),(4,1),(4,3);
...
INSERT INTO `sylius_product_image` VALUES (1,1,'image','b1/d6/dca523d99ad3f93db095aab8a5af.png'),(2,1,NULL,'78/b5/36b979862178812eff3fe7ba69ee.jpeg'),(3,1,NULL,'6e/54/84bae988290c99631be8a102eab4.jpeg'),(4,4,NULL,'89/cd/f14c083ddc64ab8562419350956e.png'),(5,4,NULL,'bc/00/a37b167493415350e1e1f4cd1fe4.jpeg');
...
INSERT INTO `sylius_product_image_product_variants` VALUES (2,1),(3,2),(4,6),(4,7),(5,6);
...
INSERT INTO `sylius_product_option` VALUES (2,'color',1,'2018-10-03 12:15:09','2018-10-03 12:15:09'),(3,'Taille',2,'2018-10-03 12:59:37','2018-10-03 12:59:37');
...
INSERT INTO `sylius_product_option_translation` VALUES (2,2,'Color','en_US'),(3,2,'Couleur','fr'),(4,3,'Size','en_US'),(5,3,'Taille','fr');
...
INSERT INTO `sylius_product_option_value` VALUES (2,2,'black'),(3,2,'white'),(4,3,'M'),(5,3,'XXL');
...
INSERT INTO `sylius_product_option_value_translation` VALUES (2,2,'Black','en_US'),(3,3,'White','en_US'),(4,2,'NoirC\'estNoir','fr'),(5,3,'PlusBlancQueBlanc','fr'),(6,4,'M','en_US'),(7,4,'M','fr'),(8,5,'XXL','en_US'),(9,5,'XXL','fr');
...
INSERT INTO `sylius_product_options` VALUES (3,2),(4,2),(4,3);
...
INSERT INTO `sylius_product_taxon` VALUES (1,1,1,0);
...
INSERT INTO `sylius_product_translation` VALUES (1,1,'Most valuable product','most-valuable-product',NULL,NULL,NULL,NULL,'en_US'),(2,1,'Le produit le plus beau du monde','le-produit-le-plus-beau-du-monde','balec balec',NULL,NULL,NULL,'fr'),(3,2,'Test','test',NULL,NULL,NULL,NULL,'en_US'),(4,2,'TestFR','testfr',NULL,NULL,NULL,NULL,'fr'),(5,3,'BelObjet','belobjet',NULL,NULL,NULL,NULL,'en_US'),(6,3,'BelObjet','belobjet',NULL,NULL,NULL,NULL,'fr'),(7,4,'sedrfyui','sedrfyui',NULL,NULL,NULL,NULL,'en_US'),(8,4,'fghjklm','fghjklm',NULL,NULL,NULL,NULL,'fr');
...
INSERT INTO `sylius_product_variant` VALUES (1,1,1,NULL,'PDT-001','2018-10-03 12:08:55','2018-10-10 17:17:27',0,4,0,999,0,NULL,NULL,NULL,NULL,1),(2,1,NULL,NULL,'PDT-001-001','2018-10-03 12:11:50','2018-10-03 12:11:50',1,1,0,10,1,NULL,NULL,NULL,NULL,1),(3,2,NULL,NULL,'PDT-002','2018-10-03 12:29:59','2018-10-03 12:30:00',0,1,0,100,1,NULL,NULL,NULL,NULL,1),(4,3,NULL,NULL,'belobj-black','2018-10-03 12:55:33','2018-10-03 12:55:50',0,2,0,500,1,NULL,NULL,NULL,NULL,1),(5,3,NULL,NULL,'bleobjet-white','2018-10-03 12:55:33','2018-10-03 12:56:01',1,2,0,500,1,NULL,NULL,NULL,NULL,1),(6,4,NULL,NULL,'black-m','2018-10-03 13:02:41','2018-10-10 16:54:08',0,2,0,20,1,NULL,NULL,NULL,NULL,1),(7,4,NULL,NULL,'black-large','2018-10-03 13:02:41','2018-10-10 16:54:22',1,2,0,50,1,NULL,NULL,NULL,NULL,1),(8,4,NULL,NULL,'white-med','2018-10-03 13:02:41','2018-10-10 17:25:28',2,2,0,0,1,NULL,NULL,NULL,NULL,1),(9,4,NULL,NULL,'white-large','2018-10-03 13:02:41','2018-10-10 17:25:33',3,2,0,0,1,NULL,NULL,NULL,NULL,1);
...
INSERT INTO `sylius_product_variant_option_value` VALUES (4,2),(5,3),(6,2),(6,4),(7,2),(7,5),(8,3),(8,4),(9,3),(9,5);
...
INSERT INTO `sylius_product_variant_translation` VALUES (1,1,'VAR1','en_US'),(2,2,'Sweet Variant','en_US'),(3,3,NULL,'en_US'),(4,1,'VAR1','fr'),(5,4,'BelObj Noir','en_US'),(6,5,'BelObjet Blanc','en_US'),(7,6,'Black M','en_US'),(8,7,NULL,'en_US'),(9,8,NULL,'en_US'),(10,9,NULL,'en_US');
...
INSERT INTO `sylius_promotion` VALUES (1,'COOL2K18','Greatest Promotion',NULL,0,0,24,0,0,'2018-10-02 00:00:00','2019-04-03 00:00:00','2018-10-03 12:18:48','2018-10-03 12:30:53');
...
INSERT INTO `sylius_promotion_action` VALUES (1,1,'order_fixed_discount','a:1:{s:7:\"default\";a:3:{s:10:\"percentage\";i:1;s:7:\"filters\";a:3:{s:18:\"price_range_filter\";a:2:{s:3:\"min\";N;s:3:\"max\";N;}s:13:\"taxons_filter\";a:1:{s:6:\"taxons\";a:0:{}}s:15:\"products_filter\";a:1:{s:8:\"products\";a:0:{}}}s:6:\"amount\";i:500;}}');
...
INSERT INTO `sylius_promotion_order` VALUES (1,1);
...
INSERT INTO `sylius_promotion_rule` VALUES (1,1,'cart_quantity','a:3:{s:5:\"count\";i:2;s:7:\"default\";a:1:{s:6:\"amount\";i:5000;}s:3:\"nth\";i:1;}');
...
INSERT INTO `sylius_shipment` VALUES (1,1,1,'cart',NULL,'2018-10-03 12:38:36','2018-10-03 12:38:36');
...
INSERT INTO `sylius_shipping_method` VALUES (1,NULL,1,NULL,'upshit','a:1:{s:7:\"default\";a:1:{s:6:\"amount\";i:15000;}}',1,'flat_rate',1,0,NULL,'2018-10-03 12:36:26','2018-10-03 12:36:26');
...
INSERT INTO `sylius_shipping_method_translation` VALUES (1,1,'UPS',NULL,'en_US'),(2,1,'UPSRoxx',NULL,'fr');
...
INSERT INTO `sylius_tax_category` VALUES (1,'TVA','TVA des pauvres',NULL,'2018-10-03 12:37:00','2018-10-03 12:37:00');
...
INSERT INTO `sylius_tax_rate` VALUES (1,1,1,'fist-in-iere','Fisting surprise',0.80000,0,'default','2018-10-03 12:37:54','2018-10-03 12:37:54');
...
INSERT INTO `sylius_taxon` VALUES (1,1,NULL,'cat-astrophe',1,2,0,0,'2018-10-03 12:40:08','2018-10-03 12:40:08');
...
INSERT INTO `sylius_taxon_image` VALUES (1,1,NULL,'88/b4/7f610f8f3452bc8ac52dbf1d8428.jpeg');
...
INSERT INTO `sylius_taxon_translation` VALUES (1,1,'Cat1','cat1',NULL,'en_US'),(2,1,'Cat1','cat1',NULL,'fr');
...
INSERT INTO `sylius_zone` VALUES (1,'europe-pognon','EuropeDesRiches','country','all'),(2,'us-rules','USPowa','country','all');
...
INSERT INTO `sylius_zone_member` VALUES (1,1,'FR'),(2,2,'US');
...
-- Dump completed on 2018-10-15 14:20:28
